...
$(".infos_left").click(function() {
  ...
  focus.addClass("restaurant--active");
  focus.find(".reservation_right").addClass("reservation_right--active");
...
$(".close_it").click(function() {
  var focus = $(this).parent();
  focus.removeClass("restaurant--active");
  focus.find(".reservation_right").removeClass("reservation_right--active");
...
function init_service() {
  ...
  setTimeout(function() {
    main_service.classList.remove("loading");
  }, 2000);
}
